package com.dwarshb.freenowsample.presentation

import org.json.JSONObject
import retrofit2.HttpException

/**
 * It is subclass of Exception class which is used to parse Network related error and help to
 * bind the response with UI.
 *
